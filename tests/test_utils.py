...
from src.utils import transaction_dictionary, get_transaction_amount
from unittest.mock import patch, mock_open
import os
import json


def test_transaction_dictionary_success():
...
def test_transaction_dictionary_file_not_found():
...
def test_transaction_dictionary_empty_file():
...
def test_get_transaction_amount(transaction, amount: float) -> None:
